<script>
    ...
    let tabs = [
        ...
        { name: "Blog", link: "https://www.youtube.com/watch?v=UMeJuq0gnjM&list=PL9JM2aC37BG03vlqyhiYX54NG_thqqvbg&index=14" },
    ];
</script>
...
>
    <h1 class="font-medium">
        <b class="font-bold nunito">Rishabh Sharma</b>
    </h1>
    ...
    <a
        href="https://github.com/Rishugeek"
        target="_blank"
