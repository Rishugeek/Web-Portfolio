<footer
    class="py-20 sm:py-32 after:w-full bg-black border-t border-solid border-violet-950 flex flex-col gap-4 sm:gap-8 
...
>
    ...
    <div class="flex flex-col gap-4 items-center justify-center">
        ...
        <p><b class="pr-2">Email</b> rishabh667788@gmail.com</p>
        <p>
